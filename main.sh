...
# to change each time
export RUN_NAME=resample.bm25.shuffled.2
export TSV_NAME=triple.small.train.shuffled.txt

# globals
export GS_FOLDER=gs://crys-west4-a/t5/${RUN_NAME}
export DATA_DIR=data/msmarco_passage/train_set/${RUN_NAME}
...
python pygaggle/data/create_msmarco_t5_training_pairs.py \
  --triples_train ${DATA_DIR}/${TSV_NAME} \
